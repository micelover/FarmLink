...
import { createUserProfile } from "@/lib/AuthContext";
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex flex-col items-center justify-center px-4 py-16">
      ...
      <p className="mt-6 text-xs text-muted-foreground text-center max-w-sm">
        ...
        <span className="text-primary cursor-pointer hover:underline underline-offset-4">Terms of Service</span>
        {" "}and{" "}
        <span className="text-primary cursor-pointer hover:underline underline-offset-4">Privacy Policy</span>.
      </p>
    </div>
  );
}
